...
// fix16e: Removed legacy gateway functions
// loadGatewayPage(), renderGatewayCards(), toggleGateway(id), setGwMode(id),
// saveGateway(id), testGateway(id) — all replaced by provider-code versions below
