#!/usr/bin/env node
// scripts/run-regression-b2-5.js — fix18-10-hotfix30-B5-R5.4-G1.6-A1.2
...
function main() {
  ...
  const { tmpRoot, cleanupRoot } = dbHelper.createOrchestratorTempRoot('a1_2');
  let rounds;
  try {
    rounds = [];
  ...
  console.log('\n======================================================================');
  console.log('REGRESSION RUNNER SUMMARY — fix18-10-hotfix30-B5-R5.4-G1.6-A1.2');
